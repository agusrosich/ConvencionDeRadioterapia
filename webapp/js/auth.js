...
const COUNTRIES = [
  { code: 'UY', name: 'Uruguay', prefix: '+598', flag: '\u{1F1FA}\u{1F1FE}' },
  { code: 'AR', name: 'Argentina', prefix: '+54', flag: '\u{1F1E6}\u{1F1F7}' },
  { code: 'BR', name: 'Brasil', prefix: '+55', flag: '\u{1F1E7}\u{1F1F7}' },
  { code: 'CL', name: 'Chile', prefix: '+56', flag: '\u{1F1E8}\u{1F1F1}' },
  { code: 'CO', name: 'Colombia', prefix: '+57', flag: '\u{1F1E8}\u{1F1F4}' },
  { code: 'MX', name: 'M\u00E9xico', prefix: '+52', flag: '\u{1F1F2}\u{1F1FD}' },
  { code: 'PY', name: 'Paraguay', prefix: '+595', flag: '\u{1F1F5}\u{1F1FE}' },
  { code: 'PE', name: 'Per\u00FA', prefix: '+51', flag: '\u{1F1F5}\u{1F1EA}' },
  { code: 'BO', name: 'Bolivia', prefix: '+591', flag: '\u{1F1E7}\u{1F1F4}' },
  { code: 'EC', name: 'Ecuador', prefix: '+593', flag: '\u{1F1EA}\u{1F1E8}' },
  { code: 'VE', name: 'Venezuela', prefix: '+58', flag: '\u{1F1FB}\u{1F1EA}' },
  { code: 'PA', name: 'Panam\u00E1', prefix: '+507', flag: '\u{1F1F5}\u{1F1E6}' },
  { code: 'CR', name: 'Costa Rica', prefix: '+506', flag: '\u{1F1E8}\u{1F1F7}' },
  { code: 'CU', name: 'Cuba', prefix: '+53', flag: '\u{1F1E8}\u{1F1FA}' },
  { code: 'DO', name: 'Rep. Dominicana', prefix: '+1', flag: '\u{1F1E9}\u{1F1F4}' },
  { code: 'GT', name: 'Guatemala', prefix: '+502', flag: '\u{1F1EC}\u{1F1F9}' },
  { code: 'HN', name: 'Honduras', prefix: '+504', flag: '\u{1F1ED}\u{1F1F3}' },
  { code: 'SV', name: 'El Salvador', prefix: '+503', flag: '\u{1F1F8}\u{1F1FB}' },
  { code: 'NI', name: 'Nicaragua', prefix: '+505', flag: '\u{1F1F3}\u{1F1EE}' },
  { code: 'PR', name: 'Puerto Rico', prefix: '+1', flag: '\u{1F1F5}\u{1F1F7}' },
  { code: 'ES', name: 'Espa\u00F1a', prefix: '+34', flag: '\u{1F1EA}\u{1F1F8}' },
  { code: 'US', name: 'Estados Unidos', prefix: '+1', flag: '\u{1F1FA}\u{1F1F8}' },
  { code: 'PT', name: 'Portugal', prefix: '+351', flag: '\u{1F1F5}\u{1F1F9}' },
  { code: 'IT', name: 'Italia', prefix: '+39', flag: '\u{1F1EE}\u{1F1F9}' },
  { code: 'FR', name: 'Francia', prefix: '+33', flag: '\u{1F1EB}\u{1F1F7}' },
  { code: 'DE', name: 'Alemania', prefix: '+49', flag: '\u{1F1E9}\u{1F1EA}' },
  { code: 'AT', name: 'Austria', prefix: '+43', flag: '\u{1F1E6}\u{1F1F9}' },
  { code: 'BE', name: 'Belgica', prefix: '+32', flag: '\u{1F1E7}\u{1F1EA}' },
  { code: 'NL', name: 'Paises Bajos', prefix: '+31', flag: '\u{1F1F3}\u{1F1F1}' },
  { code: 'CH', name: 'Suiza', prefix: '+41', flag: '\u{1F1E8}\u{1F1ED}' },
  { code: 'GB', name: 'Reino Unido', prefix: '+44', flag: '\u{1F1EC}\u{1F1E7}' },
  { code: 'IE', name: 'Irlanda', prefix: '+353', flag: '\u{1F1EE}\u{1F1EA}' },
  { code: 'SE', name: 'Suecia', prefix: '+46', flag: '\u{1F1F8}\u{1F1EA}' },
  { code: 'NO', name: 'Noruega', prefix: '+47', flag: '\u{1F1F3}\u{1F1F4}' },
  { code: 'DK', name: 'Dinamarca', prefix: '+45', flag: '\u{1F1E9}\u{1F1F0}' },
  { code: 'FI', name: 'Finlandia', prefix: '+358', flag: '\u{1F1EB}\u{1F1EE}' },
  { code: 'PL', name: 'Polonia', prefix: '+48', flag: '\u{1F1F5}\u{1F1F1}' },
  { code: 'CZ', name: 'Republica Checa', prefix: '+420', flag: '\u{1F1E8}\u{1F1FF}' },
  { code: 'HU', name: 'Hungria', prefix: '+36', flag: '\u{1F1ED}\u{1F1FA}' },
  { code: 'RO', name: 'Rumania', prefix: '+40', flag: '\u{1F1F7}\u{1F1F4}' },
  { code: 'GR', name: 'Grecia', prefix: '+30', flag: '\u{1F1EC}\u{1F1F7}' },
  { code: 'BG', name: 'Bulgaria', prefix: '+359', flag: '\u{1F1E7}\u{1F1EC}' },
  { code: 'HR', name: 'Croacia', prefix: '+385', flag: '\u{1F1ED}\u{1F1F7}' },
  { code: 'SI', name: 'Eslovenia', prefix: '+386', flag: '\u{1F1F8}\u{1F1EE}' },
  { code: 'SK', name: 'Eslovaquia', prefix: '+421', flag: '\u{1F1F8}\u{1F1F0}' },
  { code: 'EE', name: 'Estonia', prefix: '+372', flag: '\u{1F1EA}\u{1F1EA}' },
  { code: 'LV', name: 'Letonia', prefix: '+371', flag: '\u{1F1F1}\u{1F1FB}' },
  { code: 'LT', name: 'Lituania', prefix: '+370', flag: '\u{1F1F1}\u{1F1F9}' },
  { code: 'LU', name: 'Luxemburgo', prefix: '+352', flag: '\u{1F1F1}\u{1F1FA}' },
  { code: 'MT', name: 'Malta', prefix: '+356', flag: '\u{1F1F2}\u{1F1F9}' },
  { code: 'CY', name: 'Chipre', prefix: '+357', flag: '\u{1F1E8}\u{1F1FE}' },
  { code: 'IS', name: 'Islandia', prefix: '+354', flag: '\u{1F1EE}\u{1F1F8}' },
  { code: 'AL', name: 'Albania', prefix: '+355', flag: '\u{1F1E6}\u{1F1F1}' },
  { code: 'RS', name: 'Serbia', prefix: '+381', flag: '\u{1F1F7}\u{1F1F8}' },
  { code: 'UA', name: 'Ucrania', prefix: '+380', flag: '\u{1F1FA}\u{1F1E6}' },
];
